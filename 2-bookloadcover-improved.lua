-- Source https://github.com/reuerendo/koreader-patches/blob/d41cc14b9bdc7bb2bcbc1c78c10277fded230176/2-bookloadcover.lua
-- Improved to keep cover ratio (still covering the whole screen)
-- Don't show after book is opened.
...
local function showCover(filepath)
    ...
    local bg_color = Screen.night_mode and Blitbuffer.COLOR_BLACK or  Blitbuffer.COLOR_WHITE
